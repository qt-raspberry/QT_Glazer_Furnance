...
sql_program_cl::sql_program_cl(QWidget *parent): QWidget(parent)

//sql_program_cl::sql_program_cl(QWidget *parent)
//    : QWidget(parent)
//sql_program_cl::sql_program_cl()
{
...
addressLabel = new QLabel(QObject::tr("&Address:"));
addressEdit = new QTextEdit();
typeLabel = new QLabel(QObject::tr("&Type:"));
typeComboBox = new QComboBox();
nextButton = new QPushButton(QObject::tr("&Next"));
previousButton = new QPushButton(QObject::tr("&Previous"));
...
connect(mapper, &QDataWidgetMapper::currentIndexChanged,
        this, &sql_program_cl::updateButtons);
...
setWindowTitle(QObject::tr("SQL Widget Mapper"));
mapper->toFirst();
}
//! [Set up connections and layouts]

//! [Set up the main table]
void sql_program_cl::setupModel()
{
...
void sql_program_cl::updateButtons(int row)
{
